...
; <label>:5:                                      ; preds = %7, %.split
  %6 = phi i64 [ 0, %.split ], [ %13, %7 ]
  br label %15
...
; <label>:7:                                      ; preds = %15
  ...
  br i1 %14, label %.preheader, label %5
...
; <label>:15:                                     ; preds = %15, %5
  ...
  %36 = add nuw nsw i64 %16, 5
  %37 = icmp eq i64 %36, 1000
  br i1 %37, label %7, label %15

; <label>:38:                                     ; preds = %.preheader, %41
  %39 = phi i32 [ %42, %41 ], [ 0, %.preheader ]
  br label %44
