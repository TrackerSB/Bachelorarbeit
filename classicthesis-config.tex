...
\tikzset{
    ...
    myNode/.style = {rectangle, rounded corners, draw=gray, drop shadow, very thick, bottom color=blue!50!white,
    text centered, top color=white, minimum height=1.2em, minimum width=3em},
    myPath/.style = {-{Stealth[length=4mm]}, color=NavyBlue, line width=0.2em, draw, rounded corners}
}
