...
\end{enumerate}
On \autoref{fig:exampleScop} the regions of the \texttt{-O3} compiled \autoref{lst:matmulcpp} are colored \draftnote{(Change color?)} in dark and light red.
The two light red regions were detected by Polly as \scops.
So these two can applied loop optimizations on.
