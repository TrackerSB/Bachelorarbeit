...
Originally the implementation could be used with gcc.
The problem with it was, that gcc has an \ir that is not made for being human readable.
To ease development the implementation was transfered to be used with \llvm, whose \ir is more human readable.
