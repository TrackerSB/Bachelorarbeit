...
\begin{description}
    \item[Aliasing] \draftnote{Überlappung von Speicher}
    ...
    \item[Wrapping] \draftnote{Überlauf}
    \item[unsigned] \draftnote{Überlauf}
    \item[complexity] \draftnote{zu komplex?}
    \item[unprofitable] \draftnote{als unprofitabel eingestuft}
    \item[errorBlock]
    \item[infiniteLoop]
    \item[invariantLoad]
...
In the second step these candidates are again analysed for determing whether these are valid \scops.
