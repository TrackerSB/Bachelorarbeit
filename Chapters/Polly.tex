...
A \scop is a specific region with further restrictions in order to model the region in the polyhedral model which Polly is based on.\\
For being a valid \scop a region has to have \enquote{static control}.
