...
Afterwards \draftnote{in the modeling phase?} for every found candidate an optimized version of code is generated, which is surrounded by run time checks for determining optimistically the provability of the correctness of the taken assumptions.
\begin{comment}
