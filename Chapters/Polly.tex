...
\begin{itemize}
    ...
    \item All loops and conditions perfectly nested.\\
        The control flow needs to be structured such that it could be written using just \lstinline$for$ and \lstinline$if$ statements, without the need for any \lstinline$goto$, \lstinline$break$ or \lstinline$continue$.
