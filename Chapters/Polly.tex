...
The component for gcc was called Graphite and included the \pcp which is an independant interface between the \ir of gcc called GIMPLE\footnote{The name \enquote{GIMPLE} is a result of \enquote{gcc} and \enquote{Simple II}, on which GIMPLE is based. \cite{GenericGimple}} and the internal \ir \gpoly.
...
\begin{figure}[!h]
    ...
    \caption[The regiontree of \autoref{lst:matmulcpp}]{
        This is the regiontree of \autoref{lst:matmulcpp}.
...
\begin{figure}[!h]
    ...
    \caption[The SCoPtree of \texttt{-O3} compiled \autoref{lst:matmulcpp}]{
        This is the SCoPtree of \texttt{-O3} compiled \autoref{lst:matmulcpp}.
        It contains the \texttt{-O3} optimized \cfg where the most inner region is a \scop and all surrounding regions are annotated with the reason why they were rejected being a valid \scop.
