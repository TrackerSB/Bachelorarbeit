...
\begin{itemize}
    ...
    \item Unsupported terminator instruction\\
        This is occurring when a flow breaking instruction like \mintedinline{return} or \mintedinline{goto} is called within a loop.
    ...
    \item Stack allocations\\
        Stack allocations like using \mintedinline{alloca} can not be handled.
