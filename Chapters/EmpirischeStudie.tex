...
\section{Goals}
As already mentioned this study is investigating the coverage of the part which already can be automatically optimized by Polly, the impact of various reasons for these parts not beeing even larger and the impact the coverage if these reasons could be eliminated.
...
Then the coverage of paralizable regions \(R\in\mathbb{Q}\) is defined as:
\[DynCov := \frac{T_i}{T}\]
