...
\begin{itemize}
    ...
    \item Undefinded branch condition \draftnote{Condition in BB 'cleanup' neither constant nor an icmp instruction}
    \item Non-integer branch condition
    \item Undefined operands in comparison
    \item Non-affine branch condition \draftnote{Non affine branch in BB 'entry.split' with LHS: \%call and RHS: 0}
    ...
    \item Stack allocations \draftnote{Alloca instruction:   \%b = alloca i64, align 8}
