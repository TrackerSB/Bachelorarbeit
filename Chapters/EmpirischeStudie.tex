...
\(H_2\): The coverage \(DynCov_s\) is expected to be about 60\%, on average.
...
In the second experiment the average value of \(DynCov_s\) is calculated and checked whether it is near 60\%.\\
The third experiment \(DynCov_p\) and \(DynCov_s\) are compared to check whether \(DynCov_p \gg DynCov_s\).

\section{Experiment Setting}
This study uses instrumentation to retrieve precise timing informations instead of using frameworks like OProfile \cite{oprofile} or \cite{gprof}.
