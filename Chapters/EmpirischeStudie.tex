    ...
    \resizebox{!}{\textwidth}{
        \begin{minipage}{\textwidth}
            ...
            \begin{tabularx}{\textwidth}{lcC} \toprule
                ...
                \midrule
                \textbf{Benchmarks}\\
                MultiSourceApplications & \draftnote{git} & SPEC2006 input data (set:ref)\\
                MultiSourceBenchmarks & \draftnote{git} & SPEC2006 input data (set:ref)\\
                SingleSourceBenchmarks & \draftnote{git} & SPEC2006 input data (set:ref)\\
                SPEC2006 & \draftnote{git} & SPEC2006 input data (set:ref)\\
